# Phase A — The Brain (Python Backend)
### PRD 1 + PRD 2

---

> **Phase A is complete when:** The robot runs entirely from the CLI, generates art with full justification traces, learns from its own output, manages sessions, and exposes a tested FastAPI layer ready for a frontend to connect to. No TypeScript yet.
